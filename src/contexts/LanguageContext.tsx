...
const translations = {
  en: {
    ...
    about: {
      ...
      arabicaCoffee: '100% Arabica Coffee',
      arabicaCoffeeDesc: 'Coffee made from 100% Arabica beans for the perfect cup every time.',
      allDayBreakfast: 'All-Day Breakfast',
      allDayBreakfastDesc: 'Enjoy delicious breakfast options throughout the day, whenever you crave them.',
  ...
  ru: {
    ...
    about: {
      ...
      arabicaCoffee: 'Кофе 100% Арабика',
      arabicaCoffeeDesc: 'Кофе из 100% зерен арабики для идеальной чашки каждый раз.',
      allDayBreakfast: 'Завтраки весь день',
      allDayBreakfastDesc: 'Наслаждайтесь вкусными завтраками в течение всего дня, когда бы вам ни захотелось.',
  ...
  kz: {
    ...
    about: {
      ...
      arabicaCoffee: '100% Арабика кофе',
      arabicaCoffeeDesc: '100% арабика дәндерінен дайындалған кофе - әр уақытта мінсіз шыныаяқ үшін.',
      allDayBreakfast: 'Күні бойы таңғы ас',
      allDayBreakfastDesc: 'Күні бойы дәмді таңғы ас опцияларынан ләззат алыңыз, қашан қаласаңыз да.',
